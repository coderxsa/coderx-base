...
exports.getTime = (format, date) => {
    return moment(date || moment.tz('Africa/Johannesburg')).locale('id').format(format);
};
...
exports.tanggal = (numer) => {
    ...
    const gmt = new Date(0).getTime() - new Date('1 Jan 1970').getTime();
    const weton = ["sex", "on", "the", "bitch", "cum"][Math.floor(((Date.now() + gmt) / 84600000) % 5)];
